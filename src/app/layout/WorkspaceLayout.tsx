    ...
    <div className="min-h-screen bg-transparent flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        <div className="flex-1 flex flex-col w-full relative h-full">
          {/* Header */}
          <div className={`relative z-50 ${fullBleed ? 'px-6 py-3 border-b border-workspace-border/40 bg-workspace-card/10' : 'px-8 py-6'}`}>
            {header}
          </div>

          {/* Scrollable Content */}
          <main className={`relative z-10 flex-1 ${fullBleed ? 'overflow-hidden p-0' : 'overflow-y-auto px-8 pb-8'}`}>
            <motion.div
